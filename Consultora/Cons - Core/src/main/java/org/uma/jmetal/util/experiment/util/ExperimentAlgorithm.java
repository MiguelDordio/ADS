...
public class ExperimentAlgorithm<S extends Solution<?>, Result>  {
  ...
  public AlgorithmResult runAlgorithm(Experiment<?, ?> experimentData) {
    ...
    SolutionListOutput slo = new SolutionListOutput((List<S>) population);
    slo.setSeparator("\t")
        .setVarFileOutputContext(new DefaultFileOutputContext(varFile))
        .setFunFileOutputContext(new DefaultFileOutputContext(funFile))
        .print();

    return slo.getAlgorithmResult((List<S>) population);
  }
