...
public abstract class AbstractGenericSolution<T, P extends Problem<?>> implements Solution<T> {
  ...
  @Override public int hashCode() {
	...
	public BigInteger getEncryptedVariableValue(int index) {
		return encryptedVariables.get(index);
	}
	
	@Override
	public void setEncryptedVariableValue(int index, BigInteger value) {
		encryptedVariables.set(index, value);
	}
	
	@Override
	public String getEncryptedVariableValueString(int index) {
		return  encryptedVariables.get(index).toString();
	}
	...
	@Override
	public BigInteger getEncryptedEvaluation(int index) {
		return encryptedEvaluations[index];
	}
